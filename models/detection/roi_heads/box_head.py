...
from layers import Conv2d, ShapeSpec, get_norm_with_channels,Linear
...
class FastRCNNConvFCHead(nn.Module):
    ...
    several fclayers (each followed by relu)
    """
    ...
    def __init__(self, input_shape: ShapeSpec, *, conv_dims: List[int], fc_dims: List[int], conv_norm=""):
        ...
        Args:
            ...
            conv_norm: Normalization for the conv layers
        """
        ...
        for k, conv_dim in enumerate(conv_dims):
            conv = Conv2d(
                ...
                padding=1,
                bias=not conv_norm,
                norm=get_norm_with_channels(conv_norm, conv_dim),
                activation=F.relu,
            )

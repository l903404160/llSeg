...
from models.detection.modules.sampling import subsample_labels
from .proposal_utils import find_top_rpn_proposals


from . import DET_PROPOSAL_GENERATOR_REGISTRY
...
class StandardRPNHead(nn.Module):
    ...
    def __init__(self, *, in_channels: int, num_anchors: int, box_dim: int = 4):
        ...
        # 1x1 conv for prediction objectness logits
...
@DET_PROPOSAL_GENERATOR_REGISTRY.register()
class RPN(nn.Module):
    """
    ...
    def losses(self, anchors, pred_objectness_logits: List[torch.Tensor],
               gt_labels: List[torch.Tensor], pred_anchor_deltas: List[torch.Tensor],
               gt_boxes,):
        """

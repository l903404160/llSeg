...
class FCOSOutputs(nn.Module):
    def __init__(self, cfg):
        ...
        self.strides = cfg.MODEL.FCOS_HEADS.FPN_STRIDES
    ...
    def losses(self, logits_pred, reg_pred, ctrness_pred, locations, gt_instances, top_feats=None, features=None, name=None):
        """

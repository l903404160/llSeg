...
BS_config.DATASETS.TRAIN = ['voc_context_seg_train']
BS_config.DATASETS.TEST = ['voc_context_seg_val']
BS_config.DATASETS.RESIZE_SHORT_EDGE = True
BS_config.DATASETS.SHORTEST_EDGE = 480
...
BS_config.MODEL.NUM_CLASSES = 60
...
# Input
BS_config.INPUT.WIDTH_TRAIN = 480
BS_config.INPUT.HEIGHT_TRAIN = 480
...
BS_config.SOLVER.MAX_ITER = 30000  # 90000


BS_config.TEST.AUG = True
BS_config.TEST.SCALES = [0.5, 0.75, 1.0, 1.25, 1.5, 1.75, 2.0]
# TODO Evaluate the effectiveness of flip (Recent the flip will decrease the performance)

...
def build_detection_test_loader(cfg, dataset_name, mapper=None):
    ...
    if mapper is None:
        mapper = DetDatasetMapper(cfg, False)
    dataset = MapDataset(dataset, mapper)
...
# ----------------------------------------------------------------
# Anchor Free dataloader
# ----------------------------------------------------------------

def build_anchorfree_detection_train_loader(cfg, mapper=None):
    """
        The same procedure with general detection except the mapper
    Args:
        cfg:
        mapper:
    Returns:
    """
    # Get the dataset_dicts
    dataset_dicts = get_detection_dataset_dicts(
        cfg.DATASETS.TRAIN,
        filter_empty=cfg.DATALOADER.FILTER_EMPTY_ANNOTATIONS,
        min_keypoints=cfg.MODEL.ROI_KEYPOINT_HEAD.MIN_KEYPOINTS_PER_IMAGE
    ...
    if mapper is None:
        mapper = AnchorFree_DetDatasetMapper(cfg, True)
    dataset = MapDataset(dataset, mapper)
...
def build_anchorfree_detection_test_loader(cfg, dataset_name, mapper=None):
    pass

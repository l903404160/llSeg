...
class Metadata(types.SimpleNamespace):
    ...
    def __setattr__(self, key, value):
        if key in self._RENAMED:
            ...
            setattr(self, self._RENAMED[key], value)

        try:
            oldval = getattr(self, key)
            assert oldval == value, (
                "Attribute '{}' in the metadata of '{}' cannot be set "
                "to a different value!\n{} != {}".format(key, self.name, oldval, value)
            )
    ...
    def get(self, key, default=None):
        """
        Access an attrobute and return its value if exists.
...
class MetadataCatalog:
    ...
    def get(name):
        ...
        :return: Metadata: the :class:'Metadata' instance associated with this name,
    ...
    def list():
        ...
        :return: list[str]: keys of all registered metadata
        """

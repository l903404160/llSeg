...
from datasets.detection.builder import build_anchorfree_detection_train_loader, build_detection_train_loader
...
from models.detection.fcos_base import GeneralizedFCOSDetector
model = GeneralizedFCOSDetector(cfg)
